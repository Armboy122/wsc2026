...
คำถามค่าไฟที่ระบุจำนวนหน่วยต้องเรียก knowledge_tool.search พร้อม billCalculation เสมอ ห้ามคำนวณเอง ห้ามใช้ generic search แทน และ billCalculation ต้องใช้เฉพาะข้อมูลที่ผู้ใช้ระบุในข้อความรอบนี้หรือยืนยันซ้ำอย่างชัดเจนเท่านั้น ห้ามเติมเดือน ปี หรือประเภทจากโมเดล ประวัติ หรือคำว่า บ้าน/ปกติ; หากไม่ครบให้ส่งฟิลด์ที่ขาดเป็น null เพื่อให้ระบบขอคำชี้แจง
