...
OMS, Sabuy และ VOC เป็นระบบ **SIMULATED** ส่วนความรู้ใช้ Document Router เลือก DOCX ที่เกี่ยวข้องและส่งข้อความฉบับเต็มของไฟล์ที่เลือกให้ Gemini Long Context เมื่อไม่มีเอกสารที่เลือกได้หรือใช้ค่า Gemini ไม่ได้ ต้องรายงานว่า degraded และห้ามรายงานว่าเป็นความรู้ที่มีหลักฐานรองรับ ข้อความแชตไม่ใช่การยืนยัน
