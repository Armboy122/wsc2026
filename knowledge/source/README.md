...
จนกว่าจะมีเอกสารส่งออกที่หัวหน้าทีมอนุมัติเพิ่มเข้ามา Document Router จะไม่เลือกเอกสารใด และ `knowledge_tool.search` จะไม่ส่งหลักฐานสำหรับคำถามที่ corpus ไม่ครอบคลุม
